...
/* Too many login attempts. Please try again in :seconds seconds. */
    ...
    'my_letters'        => 'Мои письма',
    'email_to_chairman' => 'Обращение к Председателю Правления',
    'warning_of_email'  => 'Предупреждение!',
    'warning_email_text'=> 'Данная электронная форма будет отправлена ​​прямо на корпоративный адрес электронной почты Председателя Правления Мирзаева Ч.С.!',
