    ...
    <div class="">
        ...
        <section class="content">
            ...
            <!-- Display Validation Errors -->
                ...
                @endif
                <div class="box box-danger" style="max-height: 700px; overflow-y: scroll; opacity: 0.9">
                    ...
                    <div class="box-body">
                        ...
                        <hr>
                        @if(count($reply))
                            <strong><i class="fa fa-file-text-o margin-r-5"></i> Javob xatlari</strong>
                            @foreach($reply as $key => $value)

                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <strong>
                                        @if($value->bank_user_id == Auth::id())
                                            <i class="fa fa-user margin-r-5"></i> Men
                                        @else
                                            <i class="fa fa-user margin-r-5 text-green"></i> <span class="text-green">Mijoz</span>
                                        @endif
                                    </strong>
                                    <p>{{ $value->title }}</p>
                    ...
                    <div class="box-header with-border bg-gray">
                        ...
                        <h3 class="box-title">Javob berish</h3>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form action="{{ route('reply.acc') }}" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="bank_user_id" value="{{ Auth::id() }}" hidden />
                            </div>
                            <div class="form-group">
                    ...
                    <div class="box-footer">
                        <div class="pull-right">
                            <!-- oferta -->
                            <div class="form-group">
                                <a href="{{url('/bank-user')}}" class="btn btn-bitbucket"><i class="fa fa-backward"></i> Back</a>
                            </div>
                        </div>
                    </div>
