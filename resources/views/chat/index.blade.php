        ...
        <div class="row">
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <div class="form-group">
                                <div class="has-feedback">
                                    <input type="text" id="search_user" class="form-control" placeholder="@lang('blade.home_search')">
                                    {{csrf_field()}}
                        ...
                        <div class="#mydiv"></div>
                        <!-- /.box-header -->
                        <div class="box-body no-padding" style="overflow-y: scroll; max-height: 600px;">
                            <div class="table-responsive mailbox-messages">
                                <table class="table table-hover table-striped" id="after_searched">
                                    ...
                                    @foreach($unReadMessages as $key => $message)
                                        <div class="bg-gray disabled color-palette text-center">@lang('blade.unread_chat_messages')</div>
                                        <tr>
                                            <td class="mailbox-star"></td>
                                            <td class="mailbox-subject">
                                    ...
                                    @foreach($lastConversationUsers as $key => $value)
                                        <tr>
                                            ...
                                            <td class="mailbox-date"><b><small>{{ $value->branch_code }}</small></b></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                ...
                <div class="col-md-5">
                    ...
                    <div class="box box-success direct-chat direct-chat-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">@lang('blade.chat') - <i class="fa fa-user text-green"></i> {{ $user->lname. ' ' .$user->fname }}</h3>
                                    ...
                                    @foreach($currentMessage as $current)
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-info clearfix">
                                                <span class="direct-chat-name pull-left">{{ $current->full_name }}</span>
                                            ...
                                            <img class="direct-chat-img" src="{{ url('/admin-lte/dist/img/user.png') }}"
                                                 alt="{{ $current->full_name }}"><!-- /.direct-chat-img -->
                        ...
                        <div class="box-footer">
                            <div class="input-group form-group has-success">
                                <input type="text" name="message" id="message_chat" placeholder="@lang('blade.home_write_message') ..."
                                       class="form-control">
                                {{csrf_field()}}
                                <span class="input-group-btn">
                                <button type="submit" id="send" class="btn btn-success btn-flat"><i class="fa fa-send"></i> @lang('blade.send')</button>
                                  </span>
                            </div>
                        </div>
                        <!-- /.box-footer-->
                    ...
                    success: function (data) {
                        ...
                        if (!$.trim(data)){
                            $('#message').append('<div class="alert alert-info alert-dismissible">'+
                                ...
                                '<h4><i class="icon fa fa-ban"></i> @lang('blade.messages_chat')!</h4>'+
                                '@lang('blade.not_found_chat')'+'</div>');
                        }
                        ...
                        for (var i = 0; i < data.length; i++) {
                            $('#message').append(
                                ...
                                '<div class="direct-chat-info clearfix">' +
                                '<span class="direct-chat-name pull-left">' + data[i].lname + ' ' + data[i].fname + '</span>' +
