...
@section('content')
    ...
    <h1>
            Control Messages (Monitoring) &#8213; Count: <b style="color:red">{{ $messages->total() }}</b>
        </h1>
        <ol class="breadcrumb">
            <li><a href="/home"><i class="fa fa-dashboard"></i> @lang('blade.home_page')</a></li>
            <li class="active">Control Messages</li>
        </ol>
...
<!-- /////////////////////////////////////   HEADER   ///////////////////////////////////////////// -->
                        <div class="box-body">
                            <form action="{{route('monitoring-message-search')}}" method="POST" role="search">
                                {{ csrf_field() }}
                                <div class="row">
                                            ...
                                            <div class="form-group">
                                                <select name="user_status" class="form-control" style="width: 100%;">
                                                        @if($user_status == '')
                                                            ...
                                                            @elseif($user_status == 3 || $user_status == 0)
                                                                <option selected="selected" value="3">Passive *</option>
                                    ...
                                    <div class="col-md-12" style="text-align:center">
                                        ...
                                        <div class="form-group"> 
                                            <button type="button" class="btn btn-default" onclick="location.href='/monitoring-message';"><i class="fa fa-refresh"></i> @lang('blade.reset')</button>
                            ...
                            <tbody>
                                @foreach ($messages as $key => $value)
                                    <tr>
                                        ...
                                        <td style="max-width: 500px;word-wrap: break-word;"> {{ $value->subject }} </td>
