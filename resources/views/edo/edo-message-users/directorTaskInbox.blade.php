            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{route('d-tasks-inbox')}}" method="POST" role="search">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <a href="{{ route('d-tasks-inbox') }}" class="btn btn-default btn-flat"><i class="fa fa-refresh"></i> @lang('blade.reset')</a>
