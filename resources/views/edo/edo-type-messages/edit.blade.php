...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Type Message yaratish
                <small></small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Bosh sahifa</a></li>
                <li class="active">type message yaratish</li>
            </ol>

            @if (count($errors) > 0)
                <div class="alert alert-danger">
                    <strong>Xatolik!</strong> Type Message yaratish uchun xodimlarni belgilashingiz kerak.<br><br>
                    <ul>
        ...
        <section class="content">
            <div class="row">
                <form role="form" method="POST"
                      action="{{ url('edo-type-messages/'.$model->id) }}">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="form-group {{ $errors->has('type_message_code') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" id="type_message_code" name="type_message_code" value="{{ $model->type_message_code }}"
                                           class="form-control">
                            ...
                            <div class="box-body">
                                <div class="form-group {{ $errors->has('sort') ? 'has-error' : '' }}">
                                    ...
                                    <input type="number" id="sort" name="sort" value="{{ $model->sort }}"
                            ...
                            <div class="box-body">
                                <div class="form-group {{ $errors->has('type_code') ? 'has-error' : '' }}">
                                    ...
                                    <select class="form-control select2" name="type_code">
                                        <option value="{{ $model->type_code }}" selected>{{ $model->roles->title_ru }}</option>
