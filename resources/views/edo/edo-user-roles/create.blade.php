...
@section('content')
        ...
        <section class="content-header">
            ...
            @if (count($errors) > 0)
                <div class="alert alert-danger">
                    <strong>Xatolik!</strong> Role yaratishda xatolik mavjud.<br><br>
                    <ul>
        ...
        <section class="content">
            <div class="row">
                <form role="form" method="POST" action="{{ url('edo-user-roles') }}"
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="form-group {{ $errors->has('role_code') ? 'has-error' : '' }}">
                                    <label>Role Code Ru<span class=""></span></label>
                                    <input type="text" id="role_code" name="role_code" value="{{ old('role_code') }}"
                                           class="form-control" placeholder="Role Code Ru">
