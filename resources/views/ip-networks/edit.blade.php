    ...
    <section class="content-header">
        ...
        @if (count($errors) > 0)
            <div class="alert alert-danger">
                <strong>Xatolik!</strong> ip yaratish uchun xodimlarni belgilashingiz kerak.<br><br>
                <ul>
    ...
    <section class="content">
        <div class="row">
            <form role="form" method="POST"
                  action="{{ url('ip-networks/'.$model->id) }}">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}
                    ...
                    <div class="box box-primary">
                            ...
                            <div class="col-md-6">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label>Filial</label>
                                        <input type="text" name="filial_code" value="{{ $model->filial_code }}"
                                ...
                                <div class="box-body">
                                    <div class="form-group {{ $errors->has('ip_owner_id') ? 'has-error' : '' }}">
                                        ...
                                        <select class="form-control select2" name="ip_owner_id">
                                            <option value="{{ $model->ip_owner_id }}">{{ $model->user->lname??'' }} {{ $model->user->fname??'' }}</option>
                            ...
                            <div class="col-md-3">
                                <div class="box-body">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="ip_first" class="form-control" value="{{ $model->ip_first }}"
                                               placeholder="10.11.64.47" data-inputmask="'alias': 'ip'" data-mask>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="box-body">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="ip_second" class="form-control" value="{{ $model->ip_second }}"
                                               placeholder="192.168.91.47" data-inputmask="'alias': 'ip'" data-mask>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="box-body">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="ip_route" class="form-control" value="{{ $model->ip_route }}"
                                               placeholder="192.168.91.1" data-inputmask="'alias': 'ip'" data-mask>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ip_description" placeholder="Izoh" value="{{ $model->ip_description }}"
                                               class="form-control">
                                    </div>
                                </div>
                        ...
                        <div class="box-footer">
                            <div class="pull-right">
                                ...
                                @endif
                                <a href="{{url($url_c)}}" class="btn btn-default"><i class="fa fa-remove"></i>
                                    Bekor
                                    qilish
                                </a>
