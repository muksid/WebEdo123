            ...
            <div class="col-md-9">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="box box-widget widget-user-2">
                            ...
                            <div class="widget-user-header bg-aqua-active">
                                ...
                                <h5 class="widget-user-desc">MFO: {{$message->branch}}
                                    &amp; {{$message->job_title}}</h5>
                            </div>
                        ...
                        <ul class="mailbox-attachments clearfix">
                            @foreach ($message_files as $file)
                                ...
                                @switch(strtolower($file_ext))
                                    ...
                                    <li>
                                    <span class="mailbox-attachment-icon">
                                        <i class="fa fa-file-o text-aqua"></i>
                                    </span>
                ...
                @if(sizeof($fromUserAllMessages) > 0)
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{$message->lname .' '. $message->fname}} - @lang('blade.sender').</h3>
                        ...
                        <div class="box-body no-padding">
                            <div class="mailbox-controls">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default btn-sm text-red delete-all"  title="@lang('blade.delete')" data-url=""><i class="fa fa-trash-o text-red"></i></button>
                                </div>
                                <div class="pull-right">
            ...
            <div class="col-md-3">
                ...
                <div class="box box-success direct-chat direct-chat-success">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <span data-toggle="tooltip" title="{{$to_users->count()}} ta xodimga"
                                  class="badge bg-green">{{$to_users->count()}}</span>
                            ...
                            @foreach($to_users as $user)
                                ...
                                @if($user->is_readed == 1)
                                        <i class="fa fa-fw fa-check-square-o"
                                           style="color: #00a65a"></i> {{$user->lname}} {{$user->fname}}
                                        <span class="text-muted pull-right"
                                              style="color: #00a65a"><i class="fa fa-clock-o"></i>
                                            {{ \Carbon\Carbon::parse($user->readed_date)->format('d.m.Y H:i') }}
                                        </span>
                                    @else
                                        <i class="fa fa-fw fa-check"
                                           style="color: #dd4b39"></i> {{$user->lname}} {{$user->fname}}
                                        <span class="text-muted pull-right"></span>
                                    @endif

                                </span><!-- /.username -->
                                    <i class="fa fa-bank" style="color: #2196F3"></i> {{$user->branch_code}}
                                    <i>{{$user->job_title}}</i>
                                </div>
                            @endforeach
                        </div>
        ...
        <div class="modal-dialog modal-confirm" style="width: 50%;  margin-top: 15px; margin-bottom:15px;">
            <div class="modal-content">
                ...
                <form role="form" method="POST" action="{{ route('ef-compose') }}" enctype="multipart/form-data">
                    ...
                    <input name="mes_term" value="{{$message->mes_term}}" type="text" hidden />
